    ...
    public partial class GraphicsManager : GameWindow
    {
        ...
        public static GraphicsManager Instance
        {
            get
            {
                ...
                public GraphicsManager(int x, int y) : base(x, y, new OpenTK.Graphics.GraphicsMode(32,24,8,4), "GLImp Game Window")
                {
                        VSync = VSyncMode.On;
                ...
                {
                    return (Bitmap)(new global::System.Resources.ResourceManager("JD_AnimationEditorJD_AnimationEditor.Properties.Resources", System.Reflection.Assembly.GetExecutingAssembly())).GetObject("font");
                }

                public static Bitmap GetError()
                {
                    return (Bitmap)(new global::System.Resources.ResourceManager("JD_AnimationEditor.Properties.Resources", System.Reflection.Assembly.GetExecutingAssembly())).GetObject("error");
                }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            GL.LoadMatrix(ref modelview);
                ...
                public static void SetBackground(OpenTK.Graphics.Color4 color)
                {
                        GL.ClearColor(color);
                }

                public static void SetColor(OpenTK.Vector3 c) 
                {
                        GL.Color3(c);
                }
                #endregion
...
/*
                ...
                public void DrawCollisionBox(OpenTK.Vector3 c1, OpenTK.Vector3 c2) 
                {
                        if(c1 == null || c2 == null) {
                                return;
                        }
