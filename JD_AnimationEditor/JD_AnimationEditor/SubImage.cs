...
namespace JD_AnimationEditor
{
        ...
        public class Subimage : Image 
        {
                ...
                public override void Draw(float X, float Y, float Width, float Height) 
                {
                        ...
                        float X2 = X + Width;
                        float Y2 = Y + Height;
                        OpenTK.Vector3 white;
                        white.X = OpenTK.Graphics.Color4.White.R;
                        white.Y = OpenTK.Graphics.Color4.White.G;
                        white.Z = OpenTK.Graphics.Color4.White.B;

                        GraphicsManager.SetColor(white);
